...
ActiveRecord::Schema.define(:version => 20111114213024) do
  ...
  create_table "events", :force => true do |t|
    ...
    t.integer  "marte_event"
    t.integer  "marte_room"
    t.integer  "spam"
    t.integer  "notes"
    t.text     "location"
    t.text     "streamming_url"
    t.string   "permalink"
    t.integer  "cm_event_id"
    t.integer  "vc_mode"
    t.text     "other_participation_url"
    t.integer  "web_interface"
  end
